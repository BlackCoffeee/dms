...
<head>
    <meta charset="utf-8" />
    <title>DMS Pulau Indah Banjarmasin</title>
            ...
            <div class="container-fluid">
                ...
                <a href="index.html" class="navbar-brand mr-0 mr-md-2 logo">
                    <span class="logo-lg">
                        ...
                        <span class="d-inline h5 ml-1 text-logo">DMS Pulau Indah Banjarmasin</span>
                    </span>
                    <span class="logo-sm">
        ...
        <div class="content-page">
            ...
            <footer class="footer">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            2023 &copy; All Rights Reserved. Crafted with <i class='uil uil-heart text-danger font-size-12'></i>
                        </div>
                    </div>
                </div>
            </footer>
