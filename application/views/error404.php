...
<head>
    ...
    <link href="<?= base_url() ?>assets/icons.min.css" rel="stylesheet" type="text/css" />
    <link href="<?= base_url() ?>assets/app.min.css" rel="stylesheet" type="text/css" />
...
<body class="authentication-bg">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center mt-4">
                                ...
                                <a class="btn btn-info btn-block mt-3" href="index.html"><i class="mdi mdi-reply"></i> Return Home</a>
                            </div>
                        </div> <!-- end card-body -->
                    </div>
                    <!-- end card -->
    ...
    <!-- App js -->
    <script src="<?= base_url() ?>assets/vendor.min.js"></script>
