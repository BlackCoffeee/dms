                ...
                <table border="1" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align:center; font-size: 18px;">Tanggal Retur</th>
                            ...
                            <th style="text-align:center; font-size: 18px;">Jumlah Kembali</th>
                    ...
                    <tbody>
                        <?php foreach ($data as $row) : ?>
                            <tr>
                                <td><?= $no++ ?></td>
                                <td>#<?= $row->noInvoice ?></td>
                                <td align="center"><?= date('d-m-Y', $row->tanggalRetur) ?></td>
                                <td><?= $row->namaLengkap ?></td>
                                <td><?= $row->jumlahRetur == '0' ? 'Selesai' : 'Retur' ?></td>
                                <td><?= $row->merk . ' - ' . $row->namaBarang ?></td>
                                <td align="right"><?= rupiah($row->hargaSatuan) ?></td>
                                <td align="center"><?= $row->jumlahRetur ?></td>
                                <td align="right"><?= rupiah($row->jumlahRetur * $row->hargaSatuan) ?></td>
                                <td align="center"><?= $row->jumlahKembali ?></td>
