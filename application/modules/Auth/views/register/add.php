...
<head>
    <meta charset="utf-8" />
    <title>Register - LPPM UNISM</title>
                        ...
                        <div class="card-body p-0">
                            <div class="row">
                                <div class="col-lg-12 p-5">
                                    ...
                                    <p class="text-muted mt-0 mb-4">Create an account easily and start using the LPPM Application.</p>

                                    <form action="<?= base_url('auth/register/add_action') ?>" method="Post" class="needs-validation authentication-form" novalidate>
                                        <div class="form-group">
                                            <label for="validationCustom01" class="form-control-label">NIK</label>
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" id="validationCustom01" name="nik" class="form-control" required placeholder="Your Nik on Unism">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="number" class="form-control" name="noWa" id="validationCustom01" placeholder="Your active WhatsApp number" required>
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="password" class="form-control" name="password" required id="validationCustom01" placeholder="Enter your password">
                                                <div class="invalid-feedback">
