            ...
            <div class="card-body">
                <form action="<?= base_url($linkin . '/addAction') ?>" method="post" class="needs-validation" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" name="alamatCustomer" id="validationCustom01" required>
                        <div class="invalid-feedback">
                            Harus diisi!
                        </div>
                    </div>
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control wa" name="noTelpon" id="validationCustom01" required>
                        <div class="invalid-feedback">
                            Harus diisi!
                        </div>
                    </div>
...
<script>
    function cekUser() {
        ...
        $.ajax({
            type: 'GET',
            url: '<?= base_url("Datamaster/Sales/cekUser") ?>',
            data: "user=" + user,
