        ...
        <div class="col-sm-12">
            <div class="card-box table-responsive">
                <table border="1" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        <?php foreach ($dataRetur as $rows) : ?>
                            <tr>
                                <td align="center"><?= $no++ ?></td>
                                <td><?= $rows->merk ?></td>
                                <td><?= $rows->namaBarang ?></td>
                                <td align="right"><?= rupiah($rows->hargaSatuan) ?></td>
                                <td align="center"><?= $rows->jumlahRetur ?></td>
                                <td align="center"><?= $rows->satuan ?></td>
                                <td align="right"><?= rupiah($rows->jumlahRetur * $rows->hargaSatuan) ?></td>
                            </tr>
                        <?php endforeach ?>
                    </tbody>
