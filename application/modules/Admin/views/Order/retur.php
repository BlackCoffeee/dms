...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <form class="needs-validation" novalidate="" action="<?= base_url($linkin . '/returAction/' . $this->uri->segment(4) . '/' . $this->uri->segment(5)) ?>" method="post">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="number" name="jumlahRetur" value="<?= $row->jumlahOrder ?>" max="<?= $row->jumlahOrder ?>" class="form-control" required>
                        <div class="invalid-feedback">
                            Harus diisi!
                        </div>
                    </div>
                    <input type="text" name="jumlahOrder" value="<?= $row->jumlahOrder ?>" hidden>
